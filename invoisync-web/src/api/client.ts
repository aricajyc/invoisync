...
class ApiClient {
    ...
    // Business Profile
    getBusinessProfile() {
        return this.client.get('/business-profile');
    }

    createOrUpdateBusinessProfile(data: any) {
        return this.client.post('/business-profile', data);
    }

    deleteBusinessProfile() {
        return this.client.delete('/business-profile');
    }
